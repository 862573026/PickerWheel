...
import wheel.pick.sl.picker.adapter.NumericWheelAdapter;
import wheel.pick.sl.picker.listener.OnItemSelectedListener;
import wheel.pick.sl.picker.view.TimePickerView.Type;
import wheel.pick.sl.picker.view.base.WheelView;
...
//	private Calendar timeEnd =new GregorianCalendar(); //结束时间
    ...
    public void setPicker(int year, int month, int day, int h, int m) {
        ...
        wv_year.setLabel(context.getString(R.string.picker_year));// 添加文字
        wv_year.setCurrentItem(year - startYear);// 初始化时显示的数据

        // 月
        wv_month = (WheelView) view.findViewById(R.id.month);
        wv_month.setAdapter(new NumericWheelAdapter(1, 12, "%02d"));
        wv_month.setLabel(context.getString(R.string.picker_month));
        ...
        wv_day.setLabel(context.getString(R.string.picker_day));
        ...
        wv_mins.setLabel(context.getString(R.string.picker_minutes));// 添加文字
